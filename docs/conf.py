...
# -*- coding: utf-8 -*-
#
# TEMPLATE_PyPROJECT documentation build configuration file..
#
...
from TEMPLATE_PyPROJECT import (
   __author__,
   __copyright__,
   SHORT_VERSION,
   __version__,
...
modindex_common_prefix = ['TEMPLATE_PyPROJECT.']
...
html_logo = path_join('_static', 'TEMPLATE_PyPROJECT180_95_logo.png')
...
sidebarlogo_perpage_dict = {
   ...
   'TEMPLATE_PyPROJECT180_95_logo_bg.png': ['RequiredSoftware', 'install', 'history', 'py-modindex', 'genindex'],
}
